...
# za pokretanje TensorBoard-a
# 1. pokreni skriptu
# 2. u drugom terminalu: python -m tensorboard.main --logdir=logs/cnn
...
#izdvajanje polovine skupa podataka za ucenje u svrhu zadatka
#X_train_n = X_train_n[0:25000,:,:,:] 
...
my_callbacks = [
    ...
    keras.callbacks.TensorBoard(log_dir = 'LV9\logs\cnn', update_freq = 100)
]
